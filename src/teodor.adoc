...
=== _Contact_
image:https://github.com/TeoChirileanu/CV/blob/master/src/github.png?raw=true[github, 30, link=https://github.com/TeoChirileanu] +
image:https://github.com/TeoChirileanu/CV/blob/master/src/whatsapp.png?raw=true[phone, 30, link=(+40 748 333 619] +
image:https://github.com/TeoChirileanu/CV/blob/master/src/linkedin.png?raw=true[linkedin, 30, link=https://www.linkedin.com/in/teoch/]
|===
